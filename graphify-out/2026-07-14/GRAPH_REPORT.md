...
- 280 files · ~103,873 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 1078 nodes · 2433 edges · 70 communities (49 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.87)
...
- `ProgramStage()` --calls--> `setProgramStage()` [INFERRED]
  src/components/STG_Details/ProgramStage.jsx → src/state/action-creators/programStage.js
- `Semantic Release — Automated Versioning and Changelog` --conceptually_related_to--> `CHANGELOG` [INFERRED]
...
Cohesion: 0.07
Nodes (49): Access, AccessData, AggregationType, AttributeValueObject, AttributeValues, BaseDimensionalItemObject, BaseIdentifiableObject, BaseLinkableObject (+41 more)

### Community 1 - "Excel Data Processor"

Cohesion: 0.08
Nodes (65): DataProcessor(), healthAreasQuery, legendSetsQuery, optionSetQuery, programsQuery, currentProgramQuery, DataProcessorTracker(), dePropertiesQuery (+57 more)

### Community 2 - "Excel Importer"

Cohesion: 0.06
Nodes (53): CurrentSectionsData, CurrentStagesData, HNQISSummary, Importer(), ImportResults, ImportSummaryState, PreviousData, ProgramMetadata (+45 more)
...
Cohesion: 0.10
Nodes (27): AssessmentPreviewProps, ModernSettingsAccordionProps, H2Convert(), HNQIS_VERSIONS, metadataMutation, queryHealthAreas, queryId, queryOptions (+19 more)

### Community 5 - "PCA Scripting & Rule Types"

Cohesion: 0.11
Nodes (28): QueryDataProgramRuleVariables, PcaAttributeValue, PcaDataElement, BuildFeedbackRulesParams, BuildProgramIndicatorsParams, BuildProgramRulesParams, BuildProgramRuleVariablesParams, CompositeScoreInput (+20 more)

### Community 6 - "Stage Section Queries"

Cohesion: 0.11
Nodes (32): createMutation, deleteMetadataMutation, queryAndroidSettingsAnalytics, queryAndroidSettingsSynchronization, queryCurrentUser, queryDashboards, QueryDataAndroidSettings, QueryDataDashboards (+24 more)

### Community 7 - "Data Element Editor"

Cohesion: 0.11
Nodes (21): CriticalCalculations(), DraggableDataElement(), DataElementForm(), DataElementItem(), DataElementStatusPool, DEActionsProps, DEStatus, getDEIcon() (+13 more)

### Community 8 - "Program Attributes Modal"

Cohesion: 0.12
Nodes (17): AttributesModal(), createMutation, exitDisclaimerModal(), queryIds, queryProgram, queryTEA, ConversionStatusDialogProps, a11yProps() (+9 more)

### Community 9 - "Setup Progress Dialog"

Cohesion: 0.10
Nodes (23): ICONS, ProgressStepProps, StepStatus, androidStatus(), androidText(), ErrorAccordionProps, formatFallbackError(), ParsedError (+15 more)
...
Cohesion: 0.11
Nodes (23): metadataMutation, queryId, queryLegends, queryProgramSections, fieldSetStyle, H2Setting, orgUnitsQuery, ouUnitQuery (+15 more)
...
Cohesion: 0.11
Nodes (19): Alert, createMutation, deleteMetadataMutation, ProgramDetails(), query, queryHNQIS2Metadata, queryIds, queryPR (+11 more)

### Community 14 - "HNQIS2 Metadata Transfer"

Cohesion: 0.11
Nodes (21): dataStoreMutation, H2Metadata(), metadataMutation, queryHNQIS2Metadata, updateDataStoreMutation, H2Transfer(), metadataMutation, queryEventList (+13 more)
...
Cohesion: 0.13
Nodes (20): DependencyExport(), ProgramStage(), query, StageSections(), buildBasicFormStage(), changeAttributeValue(), characterPos(), getAttributeValue() (+12 more)
...
Cohesion: 0.11
Nodes (20): DataElementItemProps, SetupProgressDialogProps, AddedSectionState, AttributeValue, BackupData, DEActionsInterface, DEManagerState, NormalizedError (+12 more)
...
Cohesion: 0.15
Nodes (12): SharingItem(), SharingOptions(), btnOptions, entitiesQuery, metadataMutation, psDataElementAccess, queryDashboards, queryEventReport (+4 more)
...
Cohesion: 0.27
Nodes (6): InputModal(), AssignedAttributes(), BasicForm(), FormAttribute(), FormSection(), SectionsForm()
...
Cohesion: 0.18
Nodes (7): DhisApiError, MetadataErrorReport, MetadataImportResponse, MetadataObjectReport, MetadataStats, MetadataTypeReport, PcaDeMetadata

### Community 33 - "Project Docs & CI"

Cohesion: 0.33
Nodes (9): Release GitHub Actions Workflow, Bootstrap Baseline Version Tag (v2.2.1), CHANGELOG, DHIS2 App Platform, HNQIS — Health Network Quality Improvement System, Creative Commons Attribution 4.0 International License, Program Configuration App (PCA), Program Configuration App README (+1 more)
...
- **282 isolated node(s):** `{ config }`, `husky.sh script`, `config`, `name`, `title` (+277 more)
...
- **Why does `DeepCopy()` connect `Object Sharing` to `Excel Data Processor`, `Import Validation Engine`, `HNQIS2 Converter UI`, `Stage Section Queries`, `Setup Progress Dialog`, `Stage Creation & Export`, `Scripting Rule Builder`, `Program Details Editor`, `HNQIS2 Metadata Transfer`, `Program Stage & Utilities`, `Sharing UI Components`, `Org Units Screen`, `Restore & Backup`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `CustomMUIDialog` connect `Program Attributes Modal` to `Excel Importer`, `Import Validation Engine`, `HNQIS2 Converter UI`, `Setup Progress Dialog`, `Stage Creation & Export`, `Program Details Editor`, `HNQIS2 Metadata Transfer`, `About Page`, `New Program Creation`, `Org Units Screen`, `Restore & Backup`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `CustomMUIDialogTitle()` connect `Program Attributes Modal` to `Excel Importer`, `Import Validation Engine`, `HNQIS2 Converter UI`, `Setup Progress Dialog`, `Stage Creation & Export`, `Program Details Editor`, `HNQIS2 Metadata Transfer`, `About Page`, `New Program Creation`, `Org Units Screen`, `Restore & Backup`?**
