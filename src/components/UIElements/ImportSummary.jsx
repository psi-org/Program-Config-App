...
import ImportSummaryItem from './ImportSummaryItem.jsx';
    ...
    <div style={{ width: '100%', marginBottom: '0.5em' }}>
      <NoticeBox title={title}>
        <div
          style={{
            display: 'grid',
            gridTemplateRows: `repeat(${importCategories.length}, 1fr)`,
            gridGap: '1em',
          }}
        >
          {importCategories.map((category) => (
            <ImportSummaryItem
              ...
              contentsList={[
                ...
                {
                  name: 'Updated',
                  value: category.content.updated,
                  neutral: true,
                },
                {
                  name: 'Removed',
                  value: category.content.removed,
                  negative: true,
                },
              ]}
            />
