...
import { METADATA, tagStyle } from '../../configs/Constants.jsx';
      ...
      <>
        ...
        >
          ...
          <div className="ml_item-desc">
            <div style={tagStyle}>
              {removedItems.length} {tagText}
            </div>
          </div>
          <div className="ml_item-warning_error "></div>
          <div
            className="ml_item-cta"
                ...
                <div className="ml_item-cta">
                  <a
                    ...
                    href={
                      ...
                      `/dhis-web-maintenance/index.html#/edit/${route}/${elemId}`
                    }
                  >
