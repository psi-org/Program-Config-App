  ...
  function installMetadata() {
    ...
    metadataRequest.mutate({ data: metadataPackage }).then((response) => {
      if (response.status != "OK") {
        ...
        const sendToDataStore = !pcaMetadataData?.results
          ? dataStoreCreate
          : dataStoreUpdate;
  ...
  return (
    <div>
      ...
      <div className="wrapper">
        ...
        >
          {!error && (
            <NoticeBox title="Missing Required Metadata">
              <p>
                The server lacks the necessary Metadata package required to work
                correctly.
              </p>
            </NoticeBox>
          )}
