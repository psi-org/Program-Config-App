          ...
          >
            {
              ...
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  <Checkbox
                    checked={tea.displayInList}
                    onChange={(e) =>
                      handlePropChange({
                        prop: 'displayInList',
                        teaId: tea.trackedEntityAttribute.id,
                ...
                {tea.valueType === 'DATE' && (
                  <div style={{ textAlign: 'center' }}>
                    <Checkbox
                      type="checkbox"
                      checked={tea.allowFutureDate}
                      onChange={(e) =>
                        handlePropChange({
                          prop: 'allowFutureDate',
                          teaId: tea.trackedEntityAttribute.id,
                          value: e.target.checked,
                        })
                      }
                ...
                <div>
                  {useSections && (
                    <IconButton
                      onClick={() =>
                        removeFromForm(tea.trackedEntityAttribute.id)
                      }
                    >
                      <ClearIcon />
                    </IconButton>
