...
import { DHIS2_PRIMARY_COLOR } from '../../configs/Constants.jsx';
import InputModal from '../PRG_Details/InputModal.jsx';
import FormAttribute from './FormAttribute.jsx';
    ...
    <>
      <Accordion defaultExpanded={!useSections}>
        <AccordionSummary
          ...
          style={{ backgroundColor: DHIS2_PRIMARY_COLOR, color: 'white' }}
        >
          <div
            style={{
              width: '100%',
          ...
          >
            ...
            <div>
              <span>
                {name === 'Default' ? `Tracked Entity Attributes` : name}
              </span>
            </div>
            <div
