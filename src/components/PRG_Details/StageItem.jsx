...
import { tagStyle } from '../../configs/Constants.jsx';
  ...
  if (importResults?.importedSections) {
    ImportSummaryCounts = (
      <>
        <div style={tagStyle}>
          {'New Objects: ' +
            importResults.importedSections.reduce(
              (acu, cur) =>
                acu +
                (cur.newValues || 0) +
                (cur.importStatus === 'new' ? 1 : 0),
              0
            )}
        </div>
        <div style={tagStyle}>
  ...
  return (
    ...
    >
      ...
      <div className="ml_item-desc">
        <div>
          {stage.programStageSections.length} {!eventMode && 'Program Stage'}{' '}
          Sections
        </div>
        {ImportSummaryCounts}
      </div>
      ...
      <div className="ml_item-cta">
        ...
        {showValidationMessage && (
          <ValidationMessages
            objects={importResults.importedSections
              .map((section) => [section].concat(section.dataElements))
              .flat()}
