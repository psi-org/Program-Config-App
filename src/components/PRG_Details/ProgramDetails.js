...
import {DataTable,TableHead,DataTableRow,DataTableColumnHeader,TableBody,DataTableCell, Button, CircularLoader, NoticeBox} from '@dhis2/ui';
...
const ProgramDetails = () => {
    ...
    const query = {
        results: {
            ...
            id: program,
            params: {
                fields: ['id','displayName','programType','lastUpdated','programStages[id,name]']
            }
        },
    };
    ...
    return (
        ...
        <DataTable>
            <TableHead>
                <DataTableRow>
                    <DataTableColumnHeader>Program Stage</DataTableColumnHeader>
