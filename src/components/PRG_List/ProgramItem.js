    ...
    return (
        ...
        >
            <div className="ml_list-icon">
                {" "}
                {/* REMOVED ml_item-icon ... ml_item-icon TO delete cursor:move */}
                <div className="ml_item-desc" style={{ width: "3.2em" }}>
                    <div
                        style={{
                            backgroundColor: program.style?.color || "#2c6693",
                            width: "3em",
                            height: "3em",
                            minWidth: "3em",
                            minHeight: "3em",
                    ...
                    >
                        <img
                            src={`${
                                ...
                                program.style?.icon || "dhis2_logo_positive"
                            }/icon.svg`}
                            style={{
                                width: "100%",
                                height: "auto",
