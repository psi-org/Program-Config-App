...
const About = (props) => {
  ...
  return (
    <CustomMUIDialog
      open={props.aboutModal}
      maxWidth="md"
      fullWidth={true}
      onClose={() => props.setAboutModal(false)}
    >
        ...
        <Box sx={{ width: '100%' }}>
          <TabContext value={tabValue}>
            ...
            <TabPanel value="1" style={aboutTabStyle}>
              ...
              >
                <div>
                  <strong>App version</strong>: {BUILD_VERSION}
                </div>
                ...
                <div>
                  <span>
                    <strong>Program Configuration App Metadata</strong>{' '}
                    {!pcaMetadata?.results && (
                  ...
                  {pcaMetadata?.results && (
                    ...
                    >
                      <div>
                        ...
                        {pcaMetadata.results.version < PCA_METADATA_VERSION ? (
                          <span style={{ color: 'red' }}>
                            Your installed version is outdated. Latest version
                            is: {PCA_METADATA_VERSION}
                          </span>
                        ) : (
                      ...
                      <div>
                        <em>
                          Installed on:{' '}
                          {new Date(pcaMetadata.results.date).toLocaleString(
                            'en-US',
                            ABOUT_DATE_FORMAT_OPTIONS
                          )}
                        </em>
                ...
                <div>
                  <span>
                    <strong>HNQIS 2.0 Metadata</strong>{' '}
                  ...
                  {hnqis2Metadata?.results && (
                    ...
                    >
                      ...
                      <div>
                        <em>
                          Installed on:{' '}
                          {new Date(hnqis2Metadata.results.date).toLocaleString(
                            'en-US',
                            ABOUT_DATE_FORMAT_OPTIONS
                          )}
                        </em>
                ...
                <div>
                  ...
                  {localStorage.getItem('SERVER_VERSION')}
                </div>
              </div>
              <div
                style={{
              ...
              >
                ...
                >
                  The Program Configuration App is developed by{' '}
                  <a
                ...
                >
                  This version of the PCA is compatible with DHIS2 versions
                  between {MIN_VERSION.replace('.x', '')} and{' '}
            ...
            <TabPanel value="2">
              <p style={{ marginBottom: '1em' }}>
                The Program Configuration App implements the following
                libraries:
              </p>
