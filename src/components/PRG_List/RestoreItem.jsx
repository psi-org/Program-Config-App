...
const RestoreItem = (props) => {
  const downloadBackupHandler = () => {
    const blob = new Blob([JSON.stringify(props.backup.metadata)], {
      type: 'text/json',
    });
  ...
  return (
    <>
        ...
        secondaryAction={
          ...
          >
            <Button
              ...
              onClick={() => {
                props.restoreHandler(props.backup);
              }}
            >
              Restore
            </Button>
      ...
      >
        <ListItemText
          primary={
            props.backup.name + ' (Version: ' + props.backup.version + ')'
          }
          secondary={
            <React.Fragment>
              <Typography
                ...
                color="text.primary"
              >
                {props.backup.backup_date}
              </Typography>
              <br />
              {props.backup.comment.substring(0, 100)}
            </React.Fragment>
          }
        />
      </ListItem>
