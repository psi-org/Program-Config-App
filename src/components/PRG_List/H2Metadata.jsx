...
import { parseErrorsUL, versionGTE } from '../../utils/Utils.jsx';
...
const H2Metadata = (props) => {
  ...
  const { data: hnqis2Metadata, refetch: hnqis2MetadataRefetch } =
          ...
          {hnqis2Metadata?.results && (
            <>
              ...
              <NoticeBox
                ...
                title="Minimum Metadata Package Status"
              >
                <p>
                  {h2Ready
                    ? !versionGTE(
                      ...
                      ? 'The required Metadata Package is outdated, please install the newest version.'
                      : 'The required Metadata Package is available.'
                    : 'The required Metadata Package is incomplete or corrupted, please reinstall it.'}
                </p>
              </NoticeBox>
            </>
          )}
      ...
      >
        ...
        <div>
          <Button
            ...
            onClick={() => props.setH2Modal(false)}
          >
            Close
          </Button>
          <LoadingButton
            ...
            {!sending &&
              `${
                hnqis2Metadata?.results?.version === H2_METADATA_VERSION
                  ? 'Repair'
                  : 'Install'
              } Metadata (v${H2_METADATA_VERSION})`}
            {sending && `Installing...`}
          </LoadingButton>
        </div>
      </DialogActions>
