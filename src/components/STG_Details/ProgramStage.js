    ...
    results: {
        ...
        params: {
            fields:[
                ...
                'programStageDataElements[id,name,compulsory,programStage,dataElement[id,name,shortName,code,description,domainType,formName,valueType,aggregationType,optionSetValue,optionSet[id,name],legendSet[id,name],attributeValues,displayName],sortOrder]',
                'programStageSections[id,name,displayName,sortOrder,dataElements[id,name,shortName,code,description,domainType,formName,valueType,aggregationType,optionSetValue,optionSet[id,name],legendSet[id,name],attributeValues,displayName]]',
            ]
        }
    }
};
