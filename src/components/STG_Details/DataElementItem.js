...
const DataElementItem = ({ program, dePrefix, dataElement, stageDE, DEActions, section, sectionType, index, hnqisType, deStatus, isSectionMode, readOnly, setSaveStatus }) => {
