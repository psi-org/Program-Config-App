export const thinBorder = {top: { style: "thin" }, left: { style: "thin" }, bottom: { style: "thin" }, right: { style: "thin" }};
export const activeTabNumber = 1;
export const middleCenter = {wrapText: true, vertical: 'middle', horizontal: 'center'};
