...
const BUILD_DATE = 'September 04, 2026';
...
const PCA_PROGRAM_TYPE_ATTRIBUTE = 'yB5tFAAN7bI';
...
const ABOUT_DATE_FORMAT_OPTIONS = {
  year: 'numeric',
  month: 'short',
  day: 'numeric',
  hour: 'numeric',
...
const VALUE_TYPES_TRACKER = [
  ...
  {
    label: 'Positive or Zero Integer',
    value: 'INTEGER_ZERO_OR_POSITIVE',
    icon: <NumberIcon />,
  },
  ...
  {
    label: 'Tracker Associate',
    value: 'TRACKER_ASSOCIATE',
...
const AGG_TYPES = [
  ...
  { value: 'AVERAGE', label: 'Average', icon: <TimelineIcon /> },
  {
    ...
    label: 'Average (Sum in Org Unit Hierarchy)',
    icon: <TimelineIcon />,
  },
...
const DHIS2_KEY_MAP = {
  ...
  programTrackedEntityAttributeDimensionItems:
    'Program Tracked Entity Attribute Dimension Item',
...
const JSON_ATTRIBUTE_SETTINGS = [
  {
    key: 'sharings',
    label: 'Remove Sharing Settings',
    selected: false,
    affects: ['sharing'],
  },
  {
    key: 'ous',
    label: 'Remove Organisation Units',
    selected: false,
    affects: ['organisationUnits'],
  },
  {
    key: 'redates',
    label: 'Remove all "Date", "Last Updated" and "Created" fields',
    selected: false,
    affects: ['date', 'lastUpdated', 'created'],
  },
  {
    key: 'reuser',
    label: 'Remove all "Created By" and "Last Updated By" fields',
    selected: false,
    affects: ['createdBy', 'lastUpdatedBy'],
  },
  {
    key: 'recats',
    label: 'Remove every field related to "Categories"',
    selected: false,
    affects: [
      'category',
      'categoryCombo',
  ...
  {
    key: 'relegends',
    label: 'Remove Legend Sets',
    selected: false,
    affects: ['legends', 'legendSets', 'legend', 'legendSet'],
  },
];
