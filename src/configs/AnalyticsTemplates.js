...
export const AverageScoreByDistrictByPivotTable = {
  ...
  hideSubtitle: false,
  description:
    'Average Score by district (last 12 months) for the lists available in the country',
  hideLegend: false,
  externalAccess: false,
  legendDisplayStrategy: 'FIXED',
  colSubTotals: false,
...
export const NumberOfAssessmentByPivotTable = {
  ...
  hideSubtitle: false,
  description:
    'Number of Assessments by checklist (last 12 months) for all the lists available in the country',
  hideLegend: false,
  externalAccess: false,
  legendDisplayStrategy: 'FIXED',
  colSubTotals: true,
...
export const AverageGlobalScoreByColumn = {
  ...
  hideSubtitle: false,
  description:
    'Average Global Score by checklist (last 12 months) for the all the lists available in the country',
  hideLegend: false,
  externalAccess: false,
  legendDisplayStrategy: 'FIXED',
  colSubTotals: false,
...
export const AssessmentByCompetencyByColumn = {
  ...
  hideSubtitle: false,
  description:
    'Number and Percentage of Assessment by Competency Class (last 4 quarters) for the Lab OTSS list',
  hideLegend: false,
  externalAccess: false,
  legendDisplayStrategy: 'FIXED',
  colSubTotals: false,
...
export const LineListGlobalScore = {
  ...
  columnDimensions: ['pe', 'ou', '', 'F0Qcr8ANr7t'],
  columns: [],
